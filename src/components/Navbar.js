...
export default function Navbar(props) {
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      {/* <htmlForm classNameName="d-flex" role="search">
        <input classNameName="htmlForm-control me-2" type="search" placeholder="Search" aria-label="Search"/>
      ...
      <div className={`htmlForm-check htmlForm-switch text-${props.mode==='light'?'dark':'light'}`}>
          ...
          <label className="htmlForm-check-label" htmlFor="flexSwitchCheckDefault">Enable DarkMode</label>
      </div>
    </div>
  </div>
</nav>
